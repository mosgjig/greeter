...
public class GreetService {
    ...
    public String getGreetByUsername(String username) {
        ResponseEntity<UserPreferenceDto[]> responseEntity = restTemplate.getForEntity("http://localhost:8080/api/user/preferences?firstName=" + username, UserPreferenceDto[].class);
